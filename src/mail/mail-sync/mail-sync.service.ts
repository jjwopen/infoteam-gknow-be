...
export class MailSyncService {
  ...
  async downloadAttachment(id: string) {
    ...
    const accessToken = await this.graphService.getValidAccessToken();

    const graphAttachment = await this.graphService.getAttachmentContent(
      accessToken,
  ...
  async handleCron() {
    ...
    const messages = await this.graphService.getMessages(accessToken);

    await this.graphService.saveMessages(messages, accessToken);
